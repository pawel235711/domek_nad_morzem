...
![Elewacja tylna](wizualizacje/05_elewacja_tylna.png)
...
![Schody młynarskie](wizualizacje/08_wnetrze_schody.png)
...
![Widok w górę na antresolę](wizualizacje/21_wnetrze_widok_w_gore_na_antresole.png)
...
![Elewacje wszystkie](schematy/15_elewacje_wszystkie.png)
...
![Detal połączenia spawanego](schematy/17_detal_polaczenia_spawanego.png)
...
![Detal ściany warstwy](schematy/18_detal_sciany_warstwy.png)
...
## 11. Analiza możliwości odchudzenia konstrukcji {#analiza-odchudzenia}

Zgodnie z Państwa prośbą, przeprowadzono analizę możliwości redukcji masy całkowitej budynku. Poniżej przedstawiono podsumowanie wyników.

### Wnioski kluczowe

-   **Obecna masa budynku**: ok. **7,3 tony**.
-   **Najcięższy element**: Płyty OSB, stanowiące **34,8%** całkowitej masy (ok. 2,5 tony).
-   **Możliwa redukcja masy**: Nawet do **2 ton (27,8%)**, co obniżyłoby masę budynku do **5,3 tony**.

### Rekomendowany wariant: Krokwie + Deski sosnowe

**Opis**:
-   **Ściany**: 1 warstwa desek sosnowych od wewnątrz.
-   **Dach**: Krokwie drewniane 50×150 mm + deski sosnowe 25 mm.
-   **Strop antresoli**: Deski sosnowe 25 mm.
-   **Podłoga**: OSB 18 mm (bez zmian).

**Wynik**:
-   **Oszczędność masy**: **1 248 kg** (36,4% masy płyt OSB).
-   **Nowa masa budynku**: ok. **6,0 tony**.
-   **Zalety**: Dobry kompromis cena/waga, łatwa dostępność materiałów, estetyka naturalnego drewna.

### Porównanie wariantów

| Wariant | Masa [kg] | Oszczędność [kg] | Oszczędność [%] | Uwagi |
| :--- | :--- | :--- | :--- | :--- |
| **BAZOWY (OSB)** | 7 292 | - | - | Obecny projekt |
| **WARIANT 1 (krokwie+deski)** | 6 044 | 1 248 | 17,1% | **Rekomendowany** |
| **WARIANT 2 (krokwie+sklejka)** | 5 776 | 1 516 | 20,8% | Maksymalne odchudzenie |

### Dodatkowe możliwości (opcjonalne)

-   **Izolacja 8 cm zamiast 10 cm**: -111 kg (pogorszenie izolacyjności).
-   **Płyty GK zamiast boazerii**: -288 kg (zmiana estetyki).
-   **Blacha 0,5 mm zamiast 0,7 mm**: -110 kg (mniejsza odporność mechaniczna).

**Pełna analiza z obliczeniami znajduje się w pliku `ANALIZA_ODCHUDZENIA_KONSTRUKCJI.md`**.
